...
class ShellServer(Protocol):
    def dataReceived(self, data):
        ...
        if command == 'search':
            ...
            for node_id in interfaces.monitor.nodes:
                self.transport.write(str(interfaces.monitor.nodes[node_id]).encode('utf-8'))
    ...
    def do_search(self):
        profile = interfaces.monitor.get_self_node().get_profile()
